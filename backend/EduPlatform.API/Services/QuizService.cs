...
public class QuizService : IQuizService
{
    ...
    public async Task<List<QuizTopicDto>> GetTopicsAsync(int? userId = null)
    {
        ...
        var orderMap = new Dictionary<string, int>
        {
            ...
            ["css-visual"] = 14,
            ["css-advanced"] = 15,
            ["css-positioning-responsive"] = 16,
            ["css-transforms-animations"] = 17,
            ["css-variables"] = 18,
            // JavaScript - Progressive difficulty
            ["js-basics"] = 19,
            ["js-arrays-objects"] = 20,
            ["js-functions-scope"] = 21,
            ["js-dom-events"] = 22,
            ["js-es6-features"] = 23,
            ["js-advanced"] = 24,
            ["js-objects-classes"] = 25,
            ["js-async-programming"] = 26,
            ["js-modules-browser-apis"] = 27
        };
