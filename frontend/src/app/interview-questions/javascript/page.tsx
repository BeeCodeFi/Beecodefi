        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-extrabold">JavaScript Interview Questions</h1>
              <p className="text-white/90 mt-2">
                {stats.total} questions covering core concepts, async, closures, and ES6+
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all"
                />
                {searchTerm && (
                  <button
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-yellow-500 focus:border-transparent cursor-pointer"
                >
              ...
              <AnimatePresence>
                {expandedId === question.id && (
                  <motion.div
                    ...
                    className="overflow-hidden"
                  >
                    <div className="px-6 py-6 border-t-2 border-yellow-200 dark:border-yellow-900/50 bg-gradient-to-br from-yellow-50/50 via-white to-amber-50/30 dark:from-yellow-950/10 dark:via-gray-900 dark:to-amber-950/10">
                      <div
                      ...
                      <div className="flex flex-wrap gap-2 mt-6 pt-4 border-t border-yellow-200 dark:border-yellow-900/50">
                        {question.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-3 py-1 bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-300 rounded-full text-xs font-medium border border-yellow-200 dark:border-yellow-800"
                          >
                            #{tag}
                          </span>
                        ))}
