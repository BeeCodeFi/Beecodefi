...
import { typescriptInterviewQuestions } from "@/data/interview-questions/typescript-questions";
...
export default function TypeScriptInterviewQuestionsPage() {
  ...
  const { loading, toggleRevision, clearAllRevisions, isMarked, count } = useRevisions('typescript');
  const { isRead, markAsRead, readCount } = useInterviewProgress('typescript');
  const { sessionFormatted, totalFormatted } = useStudySession('typescript');
  const { getNote, saveNote, hasNote, noteCount, isAuthenticated } = useInterviewNotes('typescript');

  const filteredQuestions = typescriptInterviewQuestions.filter((q) => {
  ...
  // Calculate stats
  const beginnerQs = typescriptInterviewQuestions.filter(q => q.difficulty === 'beginner');
  const intermediateQs = typescriptInterviewQuestions.filter(q => q.difficulty === 'intermediate');
  const advancedQs = typescriptInterviewQuestions.filter(q => q.difficulty === 'advanced');

  const stats = {
    total: typescriptInterviewQuestions.length,
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <AnimatePresence>
        {showFlashcards && (
          <FlashcardMode
            questions={typescriptInterviewQuestions}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-extrabold">TypeScript Interview Questions</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent dark:bg-gray-800 dark:text-white"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent dark:bg-gray-800 dark:text-white appearance-none cursor-pointer"
              >
