...
interface Props {
  ...
  onClose: () => void;
  accentColor?: string; // tailwind gradient e.g. "from-yellow-500 to-amber-500"
}
...
export default function FlashcardMode({ questions, onClose, accentColor = "from-indigo-500 to-purple-500" }: Props) {
  ...
  // Strip markdown for flashcard display (simplified plain-text rendering)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      ...
      >
        {/* Header */}
        <div className={`bg-gradient-to-r ${accentColor} p-5 text-white`}>
            ...
            <div className="text-center py-6">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-xl font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                >
                  <RotateCcw className="w-4 h-4" />
                  Restart All
                </button>
                <button
                  onClick={onClose}
                  className="flex items-center gap-2 px-5 py-2.5 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                >
                  Exit
                </button>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <button
                    ...
                    className={cn(
                      "flex-1 w-full text-left p-6 rounded-xl border-2 transition-all cursor-pointer hover:shadow-md",
                      flipped
