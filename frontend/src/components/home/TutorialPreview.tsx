...
const meta = [
  {
    ...
    glow: "group-hover:shadow-orange-200 dark:group-hover:shadow-orange-900/40",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-blue-200 dark:group-hover:shadow-blue-900/40",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-yellow-200 dark:group-hover:shadow-yellow-900/40",
