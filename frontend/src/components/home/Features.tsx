...
const features = [
  ...
  },
  {
    ...
    description: "Free account saves lesson progress, quiz scores, and completed lessons across sessions.",
  ...
  },
  {
    ...
    description: "Every concept backed by runnable code. Live preview for HTML/CSS — see it render immediately.",
  ...
  },
  {
    icon: Zap,
    title: "Free Forever",
    description: "No paywalls, no premium tiers, no credit card. Quality education should be accessible to all.",
